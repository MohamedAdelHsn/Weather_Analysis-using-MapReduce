...
# >> hadoop jar </path_of_the_jar_file>  <jarclass_name> <input_data> <output_data>
hadoop jar '/home/hdpuser/Desktop/jars/Max_Temp.jar' com.mr.weatherAnalysis.Max_Temp /Test/sample.txt /output
