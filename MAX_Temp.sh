...
# run your own mapreduce job by passing jar file into hadoop with the following schema >> hadoop jar /path_of_the_jar_file the jarclass_name <input_data> <output_data>
